...
//        show(args);
        IntComparable[] comps = new IntComparable[1000000];
        for(int i = 0; i < comps.length; i++)
            comps[i] = new IntComparable();
...
//        show(args);
    ...
    static class IntComparable implements Comparable
    {
        ...
        public int key = StdRandom.uniform(100000000);
        @Override
        public int compareTo(Object o) {
            IntComparable comp = (IntComparable) o;
            if(key < comp.key)
                return -1;
            else if(key > comp.key)
                return 1;
            else
                return 0;
        }
